...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            {{HTML::link('admin/mailinglist/create', 'Добавить контакт в рассылку')}}
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><a href="{{URL::to('/admin/mailinglist')}}"><i class="glyphicon glyphicon-arrow-left"></i>&nbsp;Назад</a>&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-user"></i> Добавить нового подписчика  </h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <div class="box-content">
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <p>{{Form::open(array('action' => array('AdminMailinglistController@store'), 'method'=>'post'))}}</p>
                        ...
                        <table class="mytable  "><tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{ Form::text('email', '', array('class' => 'form-custom', 'size' => '30%')) }}
                                        ...
                                        <td>
                                            ...
                                            {{ Form::select('lang',$allLang, '0', array('class' => 'mydrop')) }}
