    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content" style="display: none" id="box_content_5">
                ...
                @if(file_exists(base_path() . '\public\images\informations\info_2.jpeg'))
                <p><img src="{{'/images/informations/info_2.jpeg?img='. time()}}" class="animated zoomIn"></p>
                {{Form::open(array('action' => array('AdminInformationController@update'), 'method'=>'put', 'id' => 'deleteImage5'))}}
                <br>
                {{ Form::hidden('deleteImage', '2') }}
                  {{ Form::hidden('number', '2') }}
                {{ Form::hidden('type', 'info') }}

                <a class="btn btn-danger" href="#" onclick="document.getElementById('deleteImage5').submit();
                                    return false;">
