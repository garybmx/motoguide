...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            {{HTML::link('admin/PastTour', 'Предстоящие туры')}}
        </li>
        <li>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><a href="{{URL::to('/admin/FutureTour')}}"><i class="glyphicon glyphicon-arrow-left"></i>&nbsp;Назад</a>&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-user"></i> Тур {{$tourArray['tour_id']}}</h2>
                <div class="box-icon">
