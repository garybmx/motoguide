    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><a href="{{URL::to('/admin/PastTour')}}"><i class="glyphicon glyphicon-arrow-left"></i>&nbsp;Назад</a>&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-user"></i> Редактировать мотоцикл  {{ $tourArray['tour_id'] }}</h2>
                <div class="box-icon">
                        ...
                        <div class="tab-pane active" id="rus">
                            ...
                            <tr>
                                <td>
                                    ...
                                    {{ Form::select('ru_level_id', array('0'=> 'не выбран', '1'=> 'легкий'), $tourArray['level_id'], array('class' => 'mydrop')) }}
                        ...
                        <div class="tab-pane" id="eng">
                            ...
                            <tr>
                                <td>
                                    ...
                                    {{ Form::select('en_level_id', array('0'=> 'не выбран', '1'=> 'легкий'), $tourArrayEng['level_id'], array('class' => 'mydrop')) }}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{Form::open(array('action' => array('AdminMotorcyclesController@update', $tourArray['tour_id']), 'method'=>'put', 'files'=>true))}}
