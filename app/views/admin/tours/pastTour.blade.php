...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            {{HTML::link('admin/tours', 'Прошедшие туры')}}
        </li>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-user"></i> Прошедшие туры</h2>


            </div>
            <div class="box-content">
                <div class="alert alert-info">Добавить новый тур:&nbsp;&nbsp;<a class="btn  btn-success" href="PastTour/create">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-success" href="/admin/PastTour/{{$tour['tour_id']}}">
                                    <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                                    Просмотреть
                                </a>
                                <a class="btn btn-info" href="/admin/PastTour/{{$tour['tour_id']}}/edit">
